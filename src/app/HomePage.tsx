...
import ProducstCards from "@/app/components/ProductsCards";
import ProducstCardsDown from "@/app/components/ProductsCardsDown";
          ...
          <div className="z-20 grid grid-cols-1 md:grid-cols-2 grid-rows-1 gap-4 justify-items-center items-center">
            <div className="flex justify-center flex-col">
              ...
              <p className="text-[#383838] text-sm md:text-md lg:text-lg font-light pb-6">
                ...
                various quality awards, and for five consecutive years, we've
                been considered the best gadget store!
              </p>
              <Link href={"/"}>
      ...
      <section id="ourProducts" className="px-20 py-28 my-16">
        <div className="z-20 grid grid-cols-3 space-x-28">
          <div className="flex justify-center align-middle flex-col">
            ...
            <p className="text-[#383838] text-sm md:text-md lg:text-lg font-light pb-6">
              Discover Our Best Products of the Month curated just for you. Shop
              our handpicked selection of top-rated items that are trending and
